...
namespace Palmmedia.ReportGenerator.Reporting
{
    ...
    public class DefaultAssemblyFilter : IAssemblyFilter
    {
        ...
        public DefaultAssemblyFilter(IEnumerable<string> filters)
        {
            if (filters == null)
            {
        ...
        /// <summary>
        /// Converts the given filter to a corresponding regualar expression.
        /// Special characters are escaped. Wildcards '*' are converted to '.*'.
        /// </summary>
        /// <param name="filter">The filter.</param>
        /// <returns>The regualar expression.</returns>
