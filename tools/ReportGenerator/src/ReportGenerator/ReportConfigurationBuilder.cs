...
namespace Palmmedia.ReportGenerator
{
    ...
    internal static class ReportConfigurationBuilder
    {
        ...
        internal static void ShowHelp()
        {
            ...
            Console.WriteLine("   \"-reports:coverage.xml\" \"-targetdir:C:\\report\" -reporttypes:" + ReportTypes.Latex + ";" + ReportTypes.HtmlSummary);
        ...
        /// <summary>
        /// Inititializes a <see cref="ReportConfiguration"/> instance based on "named" command line parameters.
        ...
        private static ReportConfiguration CreateBasedOnNamedArguments(string[] args)
        {
            ...
            {
                reportFiles = value.Split(new[] { ';' }, StringSplitOptions.RemoveEmptyEntries);
            }
            ...
            return new ReportConfiguration(reportFiles, targetDirectory, reportTypes, sourceDirectories, filters, verbosityLevel);
        }

        /// <summary>
        /// Inititializes a <see cref="ReportConfiguration"/> instance based on "legacy" command line parameters.
        ...
        private static ReportConfiguration CreateBasedOnLegacyArguments(string[] args)
        {
            ...
            if (args.Length > 0)
            {
                reportFiles = args[0].Split(new[] { ';' }, StringSplitOptions.RemoveEmptyEntries);
            }
